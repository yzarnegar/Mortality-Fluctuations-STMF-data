...
Since the 2020 mortality patterin has been very different for 2020 compared with previous years so although we expect to see higher mortality rate during the last weeks of the year as before due to flu season but based on model predictions there is not going to be much different from now which perhaps is underestimated due to lack of enough data for more accurate prediction.
